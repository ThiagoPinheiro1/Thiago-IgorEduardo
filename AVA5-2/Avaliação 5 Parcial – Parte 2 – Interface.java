...
public class CadastroUsuarios implements Exibivel {
    private JFrame frame;

    public CadastroUsuarios(JFrame frame) {
        this.frame = frame;
    }

    @Override
    public void exibir() {
        JOptionPane.showMessageDialog(frame, "Tela de Cadastro de Usuários");
    }
}

public class CadastroPessoas implements Exibivel {
    private JFrame frame;

    public CadastroPessoas(JFrame frame) {
        this.frame = frame;
    }

    @Override
    public void exibir() {
        JOptionPane.showMessageDialog(frame, "Tela de Cadastro de Pessoas");
    }
}

public class ListaUsuarios implements Exibivel {
    private JFrame frame;

    public ListaUsuarios(JFrame frame) {
        this.frame = frame;
    }

    @Override
    public void exibir() {
        JOptionPane.showMessageDialog(frame, "Lista de Usuários");
    }
}

public class ListaPessoas implements Exibivel {
    private JFrame frame;

    public ListaPessoas(JFrame frame) {
        this.frame = frame;
    }

    @Override
    public void exibir() {
        JOptionPane.showMessageDialog(frame, "Lista de Pessoas");
    }
}

public class ConfiguracoesSistema {
    public static final String VERSAO_SISTEMA = "1.0";
    public static final String NOME_USUARIO = "Administrador";
    public static final String DATA_ACESSO = "25/11/2024";
}
